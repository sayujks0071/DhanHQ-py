#!/usr/bin/env bash
# Enhanced Bootstrap script for Ubuntu 22.04 Lightsail VPS with Google AI integration.
# Installs dependencies, deploys a Dhan trading bot scaffold with AI platform integration,
# and enables a systemd service with automatic restarts plus daily token rotation helper.
set -euo pipefail
...
GOOGLE_AI_PLATFORM_URL="${GOOGLE_AI_PLATFORM_URL:-https://enterprise-live-trading-platform-368435418141.us-west1.run.app}"
AI_API_KEY="${AI_API_KEY:-AIzaSyBn3cecYCygxvPNZDm9MgUHr25Id2zzVa4}"
        ...
        try:
            ...
            if self.ai_platform:
                ...
                if ai_signals:
                    ...
                    logger.warning(\"AI Platform connection failed, continuing without AI\")
...
Description=Enhanced Trading Bot (Dhan + AI)
...
log "Enhanced bootstrap completed successfully!"
